...
API_KEY = os.getenv("AI_API_KEY", "demo-key")  # Đọc từ biến môi trường hoặc thay bằng khóa thật
...
def detect_image_regions(image: Image.Image):
    try:
        ...
        st.warning(f"Không tách được vùng ảnh minh họa: {e}")
        return []
...
if uploaded_file:
    if st.button("🚀 Chuyển đổi"):
        with st.spinner("Đang xử lý... Vui lòng chờ vài phút."):
