...
4.  **ĐỊNH DẠNG CÔNG THỨC TOÁN HỌC**: Mọi công thức toán học, biểu thức, hệ phương trình, ký hiệu toán học phải được định dạng bằng LaTeX inline: `${...}$`, Toán inline: `${...}$`, Toán độc lập hoặc hệ phương trình: `$begin{{cases}}...\end{{cases}}$`, Các chữ kí hiệu cho hình học và các số để dạng ${....}$.
